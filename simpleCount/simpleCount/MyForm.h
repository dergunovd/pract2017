...
#pragma endregion
	...
	private: System::Void btnCalculate_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		if (resultX && resultY) {
			...
			if (InputNumberX == InputNumberY || InputNumberX == -InputNumberY) {
				this->txtOutput->Text = "";
				errorProvider->SetError(this->txtInputX, "Деление на 0");
				errorProvider->SetError(this->txtInputY, "Деление на 0");
			}
			else {
